<div class="bg-primary" style="width:100%;min-height:765px;background-color:#176682;">
<?php
	...
	##############CRIAR CONTA DO USUÁRIO PARA TODOS OS SISTEMAS#######################
	$user_cript		=	md5($dados_do_cliente_ativacao['reg_pessoa']);
	$user			=	$dados_do_cliente_ativacao['reg_pessoa'];
	$senha_cript	=	md5($dados_do_cliente_ativacao['senha_acesso']);
	$senha_rec		=	$dados_do_cliente_ativacao['senha_acesso'];
	$nome_func		=	$dados_do_cliente_ativacao['nome_pessoa'];
	
	$queryUsuario	=	"INSERT INTO usuarios(id,user_cript,user,senha_cript,senha_rec,nome_func,nivel_acesso,depto_func,status_func,last_login)";
	$queryUsuario	.=	" VALUES(NULL,'$user_cript','$user','$senha_cript','$senha_rec','$nome_func','','','',NULL)";
