<?php
	...
	if(isset($_SESSION['email'])||isset($_SESSION['senha'])){
		...
		$email	=	$_POST['emailLogado'];
		$senha	=	$_POST['senhaLogado'];
		
		$nomeUsuario	=	$_SESSION['nome'];
		$emailCadastrado=	$_SESSION['email'];
		$senhaCadastrado=	$_SESSION['senha'];
	}
?>
<!DOCTYPE html>
          ...
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#">
				<!-- LOGOTIPO-->
              	<img src="img/logotipo.png" width="50px" style="margin:-10px 0 0 0">
				<!-- LOGOTIPO-->
              </a>
            </div>
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown" style="right:0;">
				  ...
				  <?php
					if(!isset($_SESSION['email'])||!isset($_SESSION['senha'])){
						...
						<form action="loginUsuario.php" method="post">
							<label>
								Email:<input type="email" name="email" id="email" class="campoForm">
							</label>
							<label>
								Senha:<input type="password" name="senha" id="senha" class="campoForm">
							</label>
							<input type="image" src="img/login.png" value="Login" class="botaoLogin">
						</form>
						</li>
						<li role="separator" class="divider"></li>
